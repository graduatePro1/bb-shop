<template>
  <div>
    <div class="header">
      <div id="logo" >
        <img @click="$router.push('/user')" src="https://misc.360buyimg.com/lib/img/e/logo-201305-b.png" alt="京东" width="170" height="60"
             style="position: relative ;top: -5px;cursor: pointer">
        <img src="https://storage.jd.com/retail-mall/jdc_user_passport/pc/user/passport/1.0.16/css/i/l-icon.png"
             style="position:relative; left: 20px; top: -5px" alt="欢迎登录" width="110" height="40">
      </div>

      <div class="message">
        <p><i class="iconfont icon-tips" style="position: relative;top: 2px;right:5px"></i>依据《网络安全法》，为保障您的账户安全和正常使用，请尽快完成手机号验证！
          新版<a href="https://about.jd.com/privacy/" class="black" target="_blank"
                 style="text-decoration: none;color: #666;">《京东隐私政策》</a>已上线，将更有利于保护您的个人隐私。</p>
      </div>
    ...
    <div class="main">
      <div  class="back" style="background: url(https://passport.jd.com/new/misc/2015/background.png) 0 0 no-repeat;
      z-index: 2;height: 64.5vh;margin-left: 18%">
      </div>

      <div id="login">
        <div class="logintop">
          <p><i class="iconfont icon-tips" style="position:relative; left: -3px;top: 2px"></i>京东不会以任何理由要求您转账，谨防诈骗
          </p>
        </div>
