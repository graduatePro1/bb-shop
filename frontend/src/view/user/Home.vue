<template>
  <div class="main-content">
    <div style="display: flex">
      <div class="left"></div>
      <div style="width: 66%; background-color: #fff; margin-bottom: 50px;border-radius: 15px">
          ...
          <div style="flex: 3; background-color: #F3F3F3FF; margin-top: 15px; margin-left: 15px; border-radius: 10px">
            ...
            <div style="display: flex; margin-top: 50px">
              <div style="flex: 1; text-align: center">
                <a  class="person-content" href="#" @click="navTo('/front/collect')">
                  <img src="@/assets/imgs/收藏.png" alt="" style="height: 25px; width: 25px">
                  <div>我的收藏</div>
                </a>
              </div>
              <div style="flex: 1; text-align: center">
                <a class="person-content" href="#" @click="navTo('/front/address')">
                  <img src="@/assets/imgs/店铺.png" alt="" style="height: 25px; width: 25px">
                  <div >我的地址</div>
                </a>
              </div>
              <div style="flex: 1; text-align: center">
                <a class="person-content" href="#" @click="navTo('/front/cart')">
                  <img src="@/assets/imgs/购物车.png" alt="" style="height: 25px; width: 25px">
                  <div >我的购物车</div>
                </a>
              </div>
              <div style="flex: 1; text-align: center">
                <a class="person-content" href="#" @click="navTo('/front/orders')">
        ...
        <div style="margin: 10px 5px 0 5px">
          <el-row>
            <el-col :span="5" v-for="item in goodsData">
              ...
              <div style="margin-top: 5px; font-size: 18px; color: #FF5000FF">￥{{item.price}}</div>
            </el-col>
          </el-row>
        </div>
