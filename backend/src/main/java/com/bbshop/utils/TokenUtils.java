...
//    private static AdminService staticAdminService;
    private static ShopService staticShopService;
...
//                }
                if (RoleEnum.SHOP.name().equals(role)) {
                    return staticShopService.selectById(Integer.valueOf(userId));
                }
